...
void detectObjects2()
{
    ...
    string yoloModelConfiguration = yoloBasePath + "yolov3.cfg"; // "yolov3-tiny.cfg"
    string yoloModelWeights = yoloBasePath + "yolov3.weights";   // "yolov3-tiny.weights"
    ...
    cv::Size size = cv::Size(608, 608); // Adjust for trade off speed and accuracy 320: faster 
    //320: faster 1.06s; 608: more accurate 3.57s;
    // 416: 1.87s 
